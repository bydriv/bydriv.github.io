        ...
        objects: vec![
            ...
            (
                ...
                object::Object::NPC(object::npc::new(
                    ...
                    Some(vec![
                        (
                            "*:ここのところエマはずっと".to_string(),
                            "つきできんむしてるからさ".to_string(),
                        ),
                        (
                            "*:ちきゅうでくらいぐっすり".to_string(),
                            "ねむりたいんじゃない?".to_string(),
                        ),
                        (
                            "テーリ:ぼくはむしろつきで".to_string(),
                            "ねむってみたいかも".to_string(),
                        ),
                    ]),
                )),
