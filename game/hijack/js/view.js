...
export const Teiri = {
    create: async (object) => {
        ...
        shield.x = object.x;
        shield.y = object.y - 2;
        shield.lineStyle(1, Team.color(object.team, object.hijackedByTeam).fg).moveTo(0, 0).lineTo(object.shield, 0);
        shield.lineStyle(1, Team.color(object.team, object.hijackedByTeam).bg).moveTo(object.shield, 0).lineTo(16, 0);
    ...
    update: async (object, view) => {
        view.shield.clear();
        view.shield.lineStyle(1, Team.color(object.team, object.hijackedByTeam).fg).moveTo(0, 0).lineTo(object.shield, 0);
        view.shield.lineStyle(1, Team.color(object.team, object.hijackedByTeam).bg).moveTo(object.shield, 0).lineTo(16, 0);
...
export const SecurityDrone = {
    create: async (object) => {
        ...
        shield.x = object.x;
        shield.y = object.y - 2;
        shield.lineStyle(1, Team.color(object.team, object.hijackedByTeam).fg).moveTo(0, 0).lineTo(object.shield * 8, 0);
        shield.lineStyle(1, Team.color(object.team, object.hijackedByTeam).bg).moveTo(object.shield * 8, 0).lineTo(16, 0);
    ...
    update: async (object, view) => {
        view.shield.clear();
        view.shield.lineStyle(1, Team.color(object.team, object.hijackedByTeam).fg).moveTo(0, 0).lineTo(object.shield * 8, 0);
        view.shield.lineStyle(1, Team.color(object.team, object.hijackedByTeam).bg).moveTo(object.shield * 8, 0).lineTo(16, 0);
