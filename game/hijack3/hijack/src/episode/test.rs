...
pub fn new() -> Hijack {
  Hijack {
    objects: vec![
      ...
      (
        brownfox::Control::Immovable(brownfox::Immovable::new()),
        object::Object::NPC(object::npc::new(144, 96, "pixelart/verity".to_string())),
      ),
      (
        brownfox::Control::Immovable(brownfox::Immovable::new()),
        object::Object::NPC(object::npc::new(175, 96, "pixelart/emily".to_string())),
      ),
      (
        brownfox::Control::Immovable(brownfox::Immovable::new()),
        object::Object::Drone(object::drone::new(192, 112, "pixelart/mathprobe".to_string())),
      ),
      (
        brownfox::Control::Immovable(brownfox::Immovable::new()),
        object::Object::Drone(object::drone::new(192, 128, "pixelart/lonelygem".to_string())),
      ),
      (
        brownfox::Control::Immovable(brownfox::Immovable::new()),
        object::Object::Drone(object::drone::new(176, 128, "pixelart/security-drone".to_string())),
      ),
    ],
    events: vec![],
  }
