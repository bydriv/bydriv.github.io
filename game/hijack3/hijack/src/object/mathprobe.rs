...
pub fn new(x: i32, y: i32) -> Mathprobe {
    Mathprobe {
...
impl brownfox::Moore<Input, Output> for Mathprobe {
    fn transit(&self, input: &Input) -> Mathprobe {
