...
pub fn new() -> Map { Map {
  templates: vec![
  ("map/boston/0000-0000.json".to_string(), MapTemplate {
    x: 0,
    y: 0,
    width: 320,
    height: 240,
    objects: vec![
      ...
      (
        ...
        object::Object::Maptip(object::maptip::new(
          ...
          16,
          vec![
            brownfox::Rectangle::new(0, 0, 22, 3),
          ],
      ...
      (
        ...
        object::Object::Maptip(object::maptip::new(
          ...
          16,
          vec![
            brownfox::Rectangle::new(-1, 1, 22, 4),
          ],
  ...
  ("map/boston/0000-FFFF.json".to_string(), MapTemplate {
    x: 0,
    y: 0,
    width: 320,
    height: 240,
    objects: vec![
      ...
      (
        ...
        object::Object::Maptip(object::maptip::new(
          ...
          16,
          vec![
            brownfox::Rectangle::new(0, 0, 22, 17),
          ],
          "pixelart/maptip/water/".to_string(),
          "/0.png".to_string(),
        ))
      ...
      (
        ...
        object::Object::Maptip(object::maptip::new(
          ...
          32,
          vec![
            brownfox::Rectangle::new(0, 0, 1, 8),
          ],
          "pixelart/maptip/street-light/right/".to_string(),
          ".png".to_string(),
        ))
  ...
  ("map/boston/FFFF-0000.json".to_string(), MapTemplate {
    x: 0,
    y: 0,
    width: 320,
    height: 240,
    objects: vec![
      ...
      (
        ...
        object::Object::Maptip(object::maptip::new(
          ...
          32,
          vec![
            brownfox::Rectangle::new(0, 0, 10, 1),
          ],
          "pixelart/maptip/street-light/front/".to_string(),
          ".png".to_string(),
        ))
      ...
      (
        ...
        object::Object::Maptip(object::maptip::new(
          ...
          32,
          vec![
            brownfox::Rectangle::new(-1, 0, 12, 2),
          ],
          "pixelart/maptip/tree/".to_string(),
          ".png".to_string(),
        ))
