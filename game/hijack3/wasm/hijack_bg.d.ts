...
export function view_is_pattern(a: number, b: number): number;
export function view_pattern_name(a: number, b: number, c: number): void;
export function view_pattern_width(a: number, b: number, c: number): void;
export function view_pattern_height(a: number, b: number, c: number): void;
export function view_pattern_x(a: number, b: number, c: number): void;
export function view_pattern_y(a: number, b: number, c: number): void;
