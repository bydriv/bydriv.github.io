...
\begin{proof}%
  ...
  \item $length(\Pi_1^{})=k+1$ の場合．%
    ...
    $\mathit{e}_5^{}\sqsupset_1^{}\mathit{e}_6^{}$かつ%
    $\mathit{e}_3^{}\sqsupset_1^{}\mathit{e}_6^{}$となるような%
    $\mathit{e}_6^{}$が存在する．%
    \lemmaname\ref{lemma:par_reduct1n}により%
    $\mathit{e}_5^{}\sqsupset\mathit{e}_2^{}$かつ%
    $\mathit{e}_5^{}\sqsupset\mathit{e}_6^{}$だから%
    帰納法の仮定により%
    $\mathit{e}_2^{}\sqsupset\mathit{e}_7^{}$かつ%
    $\mathit{e}_6^{}\sqsupset\mathit{e}_7^{}$となるような%
    $\mathit{e}_7^{}$が存在する．%
    $\mathit{e}_3^{}\sqsupset\mathit{e}_6^{}$かつ%
    $\mathit{e}_6^{}\sqsupset\mathit{e}_7^{}$だから%
    \lemmaname\ref{lemma:par_reduct_trans}により%
    $\mathit{e}_3^{}\sqsupset\mathit{e}_7^{}$．%
    ゆえに$\mathit{e}_2^{}\sqsupset\mathit{e}_7^{}$かつ%
    $\mathit{e}_3^{}\sqsupset\mathit{e}_7^{}$となるような%
    $\mathit{e}_7^{}$が存在する．%
  \end{itemize}%
\end{proof}%
